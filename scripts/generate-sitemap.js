...
try {
  ...
  let siteDomain = process.env.VITE_SITE_DOMAIN || "nichepinner.com";
...
async function generateSitemap() {
  try {
    ...
    if (siteConfig.domain.includes('${URL}')) {
      ...
      siteConfig.domain = "nichepinner.com";
      siteConfig.siteUrl = "https://nichepinner.com";
    }
